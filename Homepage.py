...
# Sayfa Ayarları
st.set_page_config(
    page_title="Amazon Product Recommendation Systems",
...
st.image("images/amazon_products.jpg")
...
user_id_encoded= st.sidebar.number_input("Number of User_id", min_value=1, format="%d")


df_products=recommend_products(new_df,user_id_encoded)
...
if st.sidebar.button("Submit"):
    ...
    st.table(recommend_products(new_df,user_id_encoded))
